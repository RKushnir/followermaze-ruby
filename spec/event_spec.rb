...
describe Event do
  it "builds the follow events" do
    ...
    follow.should be_a(Event::Follow)
  ...
  it "builds the unfollow events" do
    ...
    unfollow.should be_a(Event::Unfollow)
  ...
  it "builds the broadcast events" do
    ...
    broadcast.should be_a(Event::Broadcast)
  end
  ...
  it "builds the private message events" do
    ...
    private_msg.should be_a(Event::PrivateMessage)
  ...
  it "builds the status update events" do
    ...
    status_update.should be_a(Event::StatusUpdate)
    status_update.from_user_id.should == "32"
  end

  it "throws when event type is not recognized" do
    expect { described_class.build("1|X", nil) }.to raise_error(UnrecognizedEventError)
  end
end
