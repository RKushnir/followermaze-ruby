...
## Dependencies
As required, no dependencies besides Ruby MRI 1.9.3. For better performance, though, I would use a minimum-heap structure from the `algorithms` gem, in place of the standard `Array`, for storing a sorted list of events.
